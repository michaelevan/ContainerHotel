                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="{{ url("/listRestoAdmin") }}">Resto</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="{{ url("/tambahRestoAdmin")}}" class="btn btn-info" style="float: right;">+ Tambah</a><br>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="example">
                        ...
                        <tbody>
                            @if (count($listResto) <= 0)
                            <tr>
                                <td colspan="3">Tidak ada Resto</td>
                            </tr>
                            @else
                                @foreach ($listResto as $Resto)
                                    <tr>
                                        ...
                                        <td>{{ $Resto->nama }}</td>
                                        <td>
                                            @if ($Resto->is_active == 1)
                                                <a href="{{ url("banned/".$Resto->userid."") }}"><button class="btn btn-danger" type="button">Ban</button></a>
                                            @else
                                                <a href="{{ url("unbanned/".$Resto->userid."") }}"><button class="btn btn-warning" type="button">Unban</button></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
