                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="{{ url("/listCustomerAdmin") }}">Customer</a>
                            </li>
                            <li>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3">Tidak ada customer</td>
                            </tr>
                            @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($customer->is_active == 1)
                                            <a href="{{ url("banned/".$customer->userid."") }}"><button class="btn btn-danger" type="button">Ban</button></a>
                                        @else
                                            <a href="{{ url("unbanned/".$customer->userid."") }}"><button class="btn btn-warning" type="button">Unban</button></a>
                                        @endif
                                        <a href="{{ url("detailCustomerAdmin/".$customer->userid."") }}"><button class="btn btn-primary" type="button">View</button></a>
                                    </td>
                                </tr>
                            @endforeach
                            @endif
