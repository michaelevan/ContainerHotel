...
<html lang="en" class="no-js">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-white fixed-top" id="mainNav">
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger active" href="customerResepsionis">Booking</a>
            </li>
            <li class="nav-item">
    ...
    <section class="wt-section" id="dashboard" style="margin-left:10%; margin-right:10%">
        ...
        <tbody>
            ...
            @foreach ($databooking as $data)
                    <tr>
                        ...
                        <td>{{$data->Tglcin}}</td>
                        <td>{{$data->Tglcout}}</td>
                        <td><a href="{{url("detailbooking/".$data->Kodecin."")}}"><button type="button" class="btn btn-primary">Detail</button></a></td>
                    </tr>
                @endforeach
            @endif
